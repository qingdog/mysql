# 1. **存储引擎**
## 1.1 **MySQL体系结构**
![](./media/image1.jpeg){width="6.044110892388451in"
height="3.629166666666667in"}

1. 连接层

最上层是一些客户端和链接服务，包含本地sock 通信和大多数基于客户端/服务端工具实现的类似于TCP/IP的通信。主要完成一些类似于连接处理、授权认证、及相关的安全方案。在该层上引入了线程 池的概念，为通过认证安全接入的客户端提供线程。同样在该层上可以实现基于SSL的安全链接。服务 器也会为安全接入的每个客户端验证它所具有的操作权限。
...
![](./media/image2.jpeg){width="6.040644138232721in"
height="1.4427077865266842in"}
...
![](./media/image3.png){width="5.096578083989502in"
height="1.026874453193351in"}
...
![](./media/image4.jpeg){width="6.053675634295713in"
height="1.0684372265966755in"}
...
![](./media/image5.png){width="3.833332239720035in"
...
![](./media/image6.png){width="1.0104166666666667in"
...
![](./media/image7.png){width="6.179241032370953in" height="2.0562489063867018in"}

4). 逻辑存储结构

![](./media/image8.png){width="6.113670166229221in"
...
![](./media/image9.png){width="1.3541666666666667in"
...
* MyISAM ： 如果应用是以读操作和插入操作为主，只有很少的更新和删除操作，并且对事务的完整性、并发性要求不是很高，那么选择这个存储引擎是非常合适的。                         MEMORY：将所有数据保存在内存中，访问速度快，通常用于临时表及缓存。MEMORY的缺陷就是 对表的大小有限制，太大的表无法缓存在内存中，而且无法保障数据的安全性。
...
![](./media/image10.jpeg){width="5.408754374453193in"
height="2.5404166666666668in"}
...
![](./media/image13.jpeg){width="5.960671478565179in"
height="3.4422911198600175in"}
...
![](./media/image15.jpeg){width="2.814676290463692in"
...
![](./media/image19.jpeg){width="5.692381889763779in"
height="1.2206244531933508in"}
...
![](./media/image20.jpeg){width="6.024887357830271in"
height="1.8160411198600175in"}

我们可以看到，两部分：

![](data:image/绿色框框起来的部分，是索引部分，仅仅起到索引数据的作用，不存储数据。红色框框起来的部分，是数据存储部分，在其叶子节点中要存储具体的数据。
...
![](./media/image21.png){width="6.040068897637795in"
height="0.7427077865266841in"}

插入一组数据： 100 65 169 368 900 556 780 35 215 1200 234 888 158 90 1000 88

120 268 250 。然后观察一些数据插入过程中，节点的变化情况。

![](./media/image22.jpeg){width="6.042004593175853in"
...
![](./media/image23.jpeg){width="6.063334426946632in"
...
![](./media/image25.jpeg){width="6.083535651793526in"
height="2.1313538932633422in"}
...
![](./media/image26.jpeg){width="6.0401815398075245in"
height="2.925207786526684in"}
...
![](./media/image27.jpeg){width="6.110025153105862in"
...
>高度为2：
>
>​		n * 8 + (n + 1) * 6 = 16*1024 , 算出n约为 1170 1171* 16 = 18736
>
...
![](./media/image29.jpeg){width="6.14624343832021in"
height="3.193124453193351in"}
...
![](./media/image30.jpeg){width="6.119055118110237in"
height="0.9349989063867017in"}
...
![](./media/image31.jpeg){width="6.2095352143482065in"
...
![](./media/image32.jpeg){width="6.1139643482064745in"
...
![](./media/image33.jpeg){width="6.143707349081365in"
height="0.7718744531933508in"}
...
![](./media/image34.jpeg){width="6.16362532808399in"
height="0.7956244531933508in"}
...
![](./media/image35.jpeg){width="6.191192038495188in"
height="0.6937489063867016in"}

B. 检查慢查询日志 ：

最终我们发现，在慢查询日志中，只会记录执行时间超多我们预设时间（2s）的SQL，执行较快的SQL 是不会记录的。

![](./media/image36.jpeg){width="6.117985564304462in"
...
![](./media/image37.jpeg){width="6.201489501312336in"
height="1.7793744531933509in"}
...
![](./media/image39.jpeg){width="6.14073053368329in"
height="2.648124453193351in"}
...
![](./media/image40.jpeg){width="6.159235564304462in"
height="0.8888538932633421in"}
...
![](./media/image41.jpeg){width="6.079036526684164in"
height="0.76375in"}
...
![](./media/image43.jpeg){width="6.057672790901138in"
height="1.5015616797900262in"}
...
![](./media/image44.jpeg){width="6.217222222222222in"
height="0.4116655730533683in"}
...
![](./media/image46.jpeg){width="6.157833552055993in"
height="1.0872911198600175in"}
...
![](./media/image47.jpeg){width="6.19092738407699in"
height="0.6621872265966754in"}
...
![](./media/image49.jpeg){width="6.181431539807524in"
height="0.6296872265966754in"}
...
![](./media/image50.jpeg){width="6.214583333333334in"
...
![](./media/image51.jpeg){width="6.214582239720035in"
height="0.6541666666666667in"}
...
![](./media/image52.jpeg){width="6.115299650043744in"
height="0.633332239720035in"}
...
![](./media/image54.jpeg){width="6.141551837270341in"
height="0.6256244531933508in"}
...
![](./media/image55.jpeg){width="6.1032305336832895in"
height="0.632082239720035in"}
...
![](./media/image57.jpeg){width="6.135415573053368in"
...
![](./media/image60.jpeg){width="6.126190944881889in"
...
![](./media/image62.jpeg){width="6.140637576552931in"
...
![](./media/image63.jpeg){width="6.1704757217847765in"
height="0.29333333333333333in"}
...
![](./media/image65.jpeg){width="6.135416666666667in"
height="0.75in"}![](./media/image66.jpeg){width="6.19336176727909in"
height="0.757082239720035in"}
...
![](./media/image67.jpeg){width="6.16209208223972in"height="1.44375in"}接下来，我们做一个操作将profession字段值全部更新为null。
...
![](./media/image70.jpeg){width="6.140928477690289in"
height="2.669061679790026in"}

索引情况如下:

![](./media/image71.jpeg){width="6.119055118110237in"
...
![](./media/image72.jpeg){width="6.141790244969378in"
height="0.8029155730533684in"}
...
![](./media/image73.jpeg){width="6.116824146981627in"
height="0.34270778652668415in"}

C. 创建单列索引后，再次执行A中的SQL语句，查看执行计划，看看到底走哪个索引。

![](./media/image74.jpeg){width="6.11527012248469in"
...
![](./media/image75.jpeg){width="6.190225284339458in"
height="0.7882283464566929in"}
...
![](./media/image76.jpeg){width="6.1648326771653545in"
height="0.7640616797900263in"}
...
![](./media/image77.jpeg){width="6.109010279965005in"
height="0.8193744531933508in"}
...
![](./media/image78.jpeg){width="6.218682195975503in"
height="2.3649989063867016in"}
...
因为，在tb_user表中有一个联合索引 idx_user_pro_age_sta，该索引关联了三个字段profession、age、status，而这个索引也是一个二级索引，所以叶子节点下面挂的是这一行的主 键id。 所以当我们查询返回的数据在 id、profession、age、status 之中，则直接走二级索引直接返回数据了。 如果超出这个范围，就需要拿到主键id，再去扫描聚集索引，再获取额外的数据
...
![](./media/image79.jpeg){width="6.074296806649169in"
...
![](./media/image80.jpeg){width="6.135892388451444in"
height="2.6877077865266843in"}
...
![](./media/image83.jpeg){width="6.151692913385827in"
height="1.0235411198600175in"}
...
![](./media/image85.jpeg){width="6.09451334208224in"
height="1.0554166666666667in"}
...
![](./media/image86.jpeg){width="6.078781714785652in"
...
![](./media/image87.jpeg){width="6.115938320209974in"
height="0.6541666666666667in"}
...
![](./media/image88.jpeg){width="6.095693350831146in"
height="2.250624453193351in"}
...
![](./media/image89.jpeg){width="6.04995406824147in"
height="1.2918744531933508in"}
...
![](./media/image90.jpeg){width="6.1100284339457565in"
...
![](./media/image91.jpeg){width="5.6269455380577424in"
height="2.135832239720035in"}

行数据，都是存储在聚集索引的叶子节点上的。而我们之前也讲解过InnoDB的逻辑结构图：

![](./media/image92.jpeg){width="5.53906605424322in"
...
![](./media/image94.jpeg){width="5.020833333333333in"
height="1.5208333333333333in"}

③. 当第一个也写满之后，再写入第二个页，页与页之间会通过指针连接

![](./media/image95.jpeg){width="6.120839895013123in"
height="0.9280205599300088in"}

④. 当第二页写满了，再往第三页写入

![](./media/image96.jpeg){width="6.156662292213474in"
height="0.60125in"}
...
![](./media/image97.jpeg){width="6.123639545056868in"
height="0.8972911198600175in"}
...
![](./media/image99.jpeg){width="6.003047900262467in"
height="2.28375in"}

但是47所在的1#页，已经写满了，存储不了50对应的数据了。    那么此时会开辟一个新的页    3#。

![](./media/image100.jpeg){width="6.134470691163605in"
height="0.5971872265966754in"}

但是并不会直接将50存入3#页，而是会将1#页后一半的数据，移动到3#页，然后在3#页，插入50。

![](./media/image101.jpeg){width="6.123696412948381in"
height="0.5931244531933508in"}![](./media/image102.jpeg){width="6.045827865266841in"
height="0.5541655730533683in"}

移动数据，并插入id为50的数据之后，那么此时，这三个页之间的数据顺序是有问题的。   1#的下一个页，应该是3#， 3#的下一个页是2#。 所以，此时，需要重新设置链表指针。

![](./media/image103.jpeg){width="6.014153543307087in"
height="0.6372911198600175in"}
...
![](./media/image105.jpeg){width="6.029596456692913in"
height="0.54625in"}

当我们继续删除2#的数据记录

![](./media/image106.jpeg){width="5.967771216097987in"
height="0.8787489063867017in"}

当页中删除的记录达到   MERGE_THRESHOLD（默认为页的50%），InnoDB会开始寻找最靠近的页（前或后）看看是否可以将两个页合并以优化空间使用。

![](./media/image107.png){width="5.961085958005249in"
height="0.8787489063867017in"}![](./media/image108.jpeg){width="5.903031496062992in"
height="0.5462489063867016in"}


删除数据，并将页合并之后，再次插入新的数据21，则直接插入3#页

![](./media/image109.jpeg){width="6.078167104111986in"
...
1. drop index idx_user_phone_name on tb_user;

1. drop index idx_user_name on tb_user;
![](data:image/
...
1. create index idx_user_age_phone_aa on tb_user(age,phone);
...
1. 如果不可避免的出现filesort，大数据量排序时，可以适当增大排序缓冲区大小
...
![](data:image/ 的时候会直接返回这个数，效率很高； 但是如果是带条件的count，MyISAM也慢。

![](data:image/ 的时候，需要把数据一行一行地从引擎里面读出来，然后累积计数。
...
中，在未来数据被读取时，再将数据合并恢复到Buffer Pool中，再将合并后的数据刷新到磁盘中。Change Buffer的意义是什么呢?
...
我们知道，在InnoDB引擎中的内存结构中，主要的内存区域就是缓冲池，在缓冲池中缓存了很多的数 据页。   当我们在一个事务中，执行多个增删改的操作时，InnoDB引擎会先操作缓冲池中的数据，如果缓冲区没有对应的数据，会通过后台线程将磁盘中的数据加载出来，存放在缓冲区中，然后将缓冲池中 的数据修改，修改后的数据页我们称为脏页。 而脏页则会在一定的时机，通过后台线程刷新到磁盘
